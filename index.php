	...
	<div class="container">
		<div class="row">
				...
				<div class="col-sm-4 col-md-4 jumbotron" style="margin-top:100px;">
					...
					<div class="bg-success text-white" style="padding:10px; border-radius:3px;"> <i class="fa fa-unlock"></i> &nbsp;  &nbsp; Supply your credentials </div><br/>
	<form action="" method="post">
			<label for="email">Email</label><br/>
				<input type="text" name="email" id="email" required style="width:100%; border-radius:5px; border:1px solid #eee; height:34px; text-indent:10px;"/><br/>
				<br/>
